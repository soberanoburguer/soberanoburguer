...
export default function Atmosphere() {
  return (
    <section id="location" className="py-24 px-4 relative bg-brand-charcoal">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div className="order-2 lg:order-1 relative group">
          ...
          <div className="absolute bottom-6 left-6 right-6 glass-card p-6 rounded-2xl flex items-center justify-between">
            <div>
              <span className="text-brand-amber font-bold text-sm block">Aberto Agora</span>
              <span className="text-white text-xs opacity-60">Até às 23:00</span>
            </div>
        ...
        <div className="order-1 lg:order-2">
          ...
          <p className="text-foreground/40 text-sm mb-2">Rua X, nº 00 - Tibiri II, Santa Rita - PB</p>
          <a 
